...
class EditUserScreen extends StatefulWidget {
  ...
  EditUserScreen(this._userPassData);
  @override
  _EditUserScreenState createState() => new _EditUserScreenState(_userPassData);
}

class _EditUserScreenState extends State<EditUserScreen> {
  var _userPassData = List.filled(2, '', growable: false);

  _EditUserScreenState(this._userPassData);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text(
          'ویرایش کاربری', style: TextStyle(fontFamily: "Vazir", fontSize: 17),),
        ...
        child: Stack(
            children: <Widget>[
              InAppWebView(
                ...
                initialUrlRequest:
                URLRequest(
                    url: WebUri.uri(Uri.parse(GlobalKeys.ebargeUrl + '/index.php?option=com_ebarge&view=ebusereditprofile&layout=edit&tmpl=component&editwhere=joomuser'),),
                    method: "post",
