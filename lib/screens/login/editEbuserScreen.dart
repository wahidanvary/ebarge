...
class EditEbuserScreen extends StatefulWidget {
  var _userPassData = List.filled(2, '', growable: false);
  EditEbuserScreen(this._userPassData);
  @override
  _EditEbuserScreenState createState() => new _EditEbuserScreenState(_userPassData);
}

class _EditEbuserScreenState extends State<EditEbuserScreen> {
  var _userPassData = List.filled(2, '', growable: false);

  _EditEbuserScreenState(this._userPassData);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text(
          'ویرایش اطلاعات آموزشی', style: TextStyle(fontFamily: "Vazir", fontSize: 17),),
        ...
        child: Stack(
            children: <Widget>[
              InAppWebView(
                ...
                initialUrlRequest:
                URLRequest(
                    url: WebUri.uri(Uri.parse(GlobalKeys.ebargeUrl + '/index.php?option=com_ebarge&view=ebusereditprofile&layout=edit&tmpl=component'),),
                    method: "post",
                ...
                shouldOverrideUrlLoading: (controller, navigationAction) async {
                  ...
                  if (![
                    ...
                    "javascript",
                    "about"
                  ].contains(uri!.scheme)) {return NavigationActionPolicy.CANCEL;
                  }
