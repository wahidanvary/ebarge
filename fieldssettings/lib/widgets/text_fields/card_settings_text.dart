        ...
        decoration: InputDecoration(
         ...
         // border: InputBorder.none,
          ...
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(8.0), // گوشه‌های گردتر
            borderSide: BorderSide.none, // حذف Border پیش‌فرض
          ),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10.0),
            borderSide: BorderSide(color: Colors.grey.shade300, width: 1.5), // Border در حالت فعال
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10.0),
            borderSide: const BorderSide(color: Colors.indigoAccent, width: 1.5), // Border در حالت فوکوس
          ),
          errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10.0),
            borderSide: const BorderSide(color: Colors.purpleAccent, width: 1.0), // Border در حالت خطا
          ),
          focusedErrorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10.0),
            borderSide: const BorderSide(color: Colors.deepPurple, width: 1.5), // Border در حالت خطای فوکوس
          ),
          errorStyle: const TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold),
          floatingLabelBehavior: FloatingLabelBehavior.auto, // لیبل به صورت خودکار حرکت می‌کند
